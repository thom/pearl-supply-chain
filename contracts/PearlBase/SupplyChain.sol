...
import "../PearlAccessControl/PearlFarmerRole.sol";
import "../PearlAccessControl/DistributorRole.sol";
import "../PearlAccessControl/RetailerRole.sol";
import "../PearlAccessControl/ConsumerRole.sol";
import "../PearlCore/Ownable.sol";

// Define a contract 'SupplyChain'
contract SupplyChain is PearlFarmerRole, DistributorRole, RetailerRole, ConsumerRole, Ownable {
  // Define 'owner'
  address _owner;
  ...
  modifier onlyOwner() {
    require(msg.sender == _owner, "sender must be the owner of the contract");
    _;
  }
